...
- `app-rr` (tahle větev) — DB-agnostická základna (obdoba `app` níže), ale na React Router v7
  místo Next.js. Historicky vychází z `app`, ale dál se s Next.js řetězcem nijak nemerguje ani
  nesynchronizuje — jde o oddělenou stack, ne o náhradu za `app` v hlavním řetězci.
